...
class TestK8sClient:
    ...
    @patch('citrouille.kube_client.client.AppsV1Api')
    @patch('citrouille.kube_client.client.CoreV1Api')
    def test_get_deployments_multiple_containers(self, mock_core_v1, mock_apps_v1_class, mock_load_config):
        mock_apps_v1 = Mock()
        mock_apps_v1_class.return_value = mock_apps_v1
        ...
        mock_deployment.spec.template.spec.containers = [mock_container1, mock_container2]
    ...
    @patch('citrouille.kube_client.client.AppsV1Api')
    @patch('citrouille.kube_client.client.CoreV1Api')
    def test_get_all_deployments(self, mock_core_v1, mock_apps_v1_class, mock_load_config):
        mock_apps_v1 = Mock()
        mock_apps_v1_class.return_value = mock_apps_v1
    ...
    @patch('citrouille.kube_client.client.AppsV1Api')
    @patch('citrouille.kube_client.client.CoreV1Api')
    def test_get_deployments_none_replicas(self, mock_core_v1, mock_apps_v1_class, mock_load_config):
        mock_apps_v1 = Mock()
        mock_apps_v1_class.return_value = mock_apps_v1
